...
public class FragmentMemberCentre extends Fragment {
    ...
    public static FragmentMemberCentre newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        member_login = view.findViewById(R.id.member_login);
    ...
    private void setMemberLogin(){

        member_login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FragmentMemberCentre.this.getActivity(), Login.class));
            }
        });
